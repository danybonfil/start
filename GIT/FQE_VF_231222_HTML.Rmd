...
![Vote Margin vs RDI Growth and Economic Evaluations](C:/Users/danbo/OneDrive%20-%20Fundacao%20Getulio%20Vargas%20-%20FGV/FGV/Q3.23/GIT/GIT/incmarg.png){ width=100% height=100% #fig:label .center }
...
```{r include_table, results='asis', echo=FALSE}
cat("<h3>Table 1: Economic Evaluations and Incumbent Margin vs RDI Growth</h3>")
htmltools::includeHTML("table_1.html")
```
...
![DAG: Moderators](C:/Users/danbo/OneDrive%20-%20Fundacao%20Getulio%20Vargas%20-%20FGV/FGV/Q3.23/GIT/GIT/dag_plot.png){ width=75% height=75% #fig:label .center }
...
```{r include_table2, results='asis', echo=FALSE}
cat("<h3>Table 2: Hypothetical Economies Framing Manipulation</h3>")
htmltools::includeHTML("table_2.html")
```
...
```{r include_table3, results='asis', echo=FALSE}
cat("<h3>Table 3: Real Economies Framing and Affective Manipulation</h3>")
htmltools::includeHTML("table_3.html")
```
